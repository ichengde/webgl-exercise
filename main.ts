...
// @ts-ignore
import j1 from './resource/1.jpg';
// @ts-ignore
import j2 from './resource/2.jpg';
// @ts-ignore
import j3 from './resource/3.jpg';
...
out vec4 outColor;
void main() {
   outColor = vec4(1.0,0.5,0.4,1);
}
`;


var canvas = document.getElementById("canvas");
const gl = (canvas as HTMLCanvasElement)!.getContext("webgl2") as WebGL2RenderingContext;
if (gl === null) {
    throw new Error('no gl')
}

var program = (webglUtils as any).createProgramFromSources(gl,
...
function loadImageAndCreateTextureInfo(url: any) {
...
var textureInfos = [
    // loadImageAndCreateTextureInfo(j1),
    loadImageAndCreateTextureInfo(j2),
    // loadImageAndCreateTextureInfo(j3),
];
var drawInfos: any[] = [];
var numToDraw = 3;
var speed = 60;
...
function update(deltaTime: any) {
    drawInfos.forEach(function (drawInfo, iii) {
        // iii === 0 && console.log(drawInfo)
...
function drawImage(tex: any, texWidth: any, texHeight: any, dstX: any, dstY: any) {
    ...
    var matrix = m4.orthographic(
        0, (gl.canvas as HTMLCanvasElement).clientWidth, (gl.canvas as HTMLCanvasElement).clientHeight, 0, -1, 1);
